...
function parseLine(line) {
    ...
    if (groups) {
        ...
        if (file.isSymbolicLink) {
            var end = name_1.indexOf(" -> ");
            if (end !== -1) {
                file.name = name_1.substring(0, end);
                file.link = name_1.substring(end + 4);
            }
        }
        return file;
    }
