        ...
        if ( (options = arguments[ i ]) != null ) {
            ...
            for ( name in options ) {
                ...
                if ( deep && copy && ( isPlainObject(copy) || (copyIsArray = Array.isArray(copy)) ) ) {
                    ...
                    target[ name ] = MargeObj( deep, clone, copy );
...
function setConfig(customConfig) {
    config = MargeObj(config, customConfig);
    ...
    return new Promise(function (resolve) {
        ...
        if (activeNotifications.length < config.maxVisibleNotifications) {
            ...
            getWindow().then(function (notificationWindow) {
                ...
                notificationWindow.webContents.on('will-navigate', notificationObj.handleRedirect);
                notificationWindow.webContents.on('new-window',    notificationObj.handleRedirect);
